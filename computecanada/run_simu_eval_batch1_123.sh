...
for mt in "edgeRLRT" "edgeRLRTcensus" "edgeRLRTdeconv" "edgeRQLF" "edgeRQLFDetRate" "limmatrend" "MASTcpm" "MASTcpmDetRate" "MASTtpmDetRate" "MASTtpm" "voomlimma" "Wilcoxon" "ttest" "LR" "NsLogit" "SeuratBimod" "SeuratBimodIsExpr2" "scDD"
